...
Next step: run `lobstercash permissions card request --amount <n> --description "<desc>"` or `lobstercash permissions crypto request --amount <n> --description "<desc>"` — both handle wallet linking automatically.
